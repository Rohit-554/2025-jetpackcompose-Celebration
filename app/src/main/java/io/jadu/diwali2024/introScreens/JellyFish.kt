...
import io.jadu.diwali2024.introScreens.JellyFishPaths.bubble1
import io.jadu.diwali2024.introScreens.JellyFishPaths.bubble2
import io.jadu.diwali2024.introScreens.JellyFishPaths.bubble3
import io.jadu.diwali2024.introScreens.JellyFishPaths.bubble4
import io.jadu.diwali2024.introScreens.JellyFishPaths.bubble5
import io.jadu.diwali2024.introScreens.JellyFishPaths.face
import io.jadu.diwali2024.introScreens.JellyFishPaths.freckle1
import io.jadu.diwali2024.introScreens.JellyFishPaths.freckle2
import io.jadu.diwali2024.introScreens.JellyFishPaths.freckle3
import io.jadu.diwali2024.introScreens.JellyFishPaths.freckle4
import io.jadu.diwali2024.introScreens.JellyFishPaths.leftEye
import io.jadu.diwali2024.introScreens.JellyFishPaths.mouth
import io.jadu.diwali2024.introScreens.JellyFishPaths.outerJelly
import io.jadu.diwali2024.introScreens.JellyFishPaths.rightEye
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle2
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle3
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle4
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle5
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle6
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle7
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle8
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentacle9
import io.jadu.diwali2024.introScreens.JellyFishPaths.tentaclePath
...
@Composable
fun JellyfishAnimation(navHostController: NavHostController) {
    ...
    if (touchCount.value == 2) {
        LaunchedEffect(touchCount.value) {
           // delay(500)
    ...
    DisposableEffect(touchCount) {
        onDispose {
            touchCount.value = 0
             scope.launch {
                blinkAlphaAnimation.stop()
                blinkScaleAnimation.stop()
             }
        }
    }
    ...
    val vectorPainter = rememberVectorPainter(
        ...
        Group(name = "jellyfish", translationY = translationY) {
            ...
            Group(name = "bubbles",  scaleY = blinkScaleAnimation.value) {
                Path(
                    bubble1,
                    fill = solidWhite,
...
object JellyFishPaths {
    ...
    val openMouth = PathParser().parsePathString(
        "M286.84 244c-3.5 6-12.5 6-16 0 0-7 3.5-10 8-10s8 3 8 10z"
    ).toNodes()

    val upperLip = PathParser().parsePathString(
        "M286.84 239s-.11-.12-.32-.31a9.91 9.91 0 0 1-.81-.76l-.5-.53c-.16-.2-.31-.41-.48-.61s-.27-.46-.41-.69a6.83 6.83 0 0 1-.29-.75 5.86 5.86 0 0 1-.06-3 7.71 7.71 0 0 1 .29-1.05 3.46 3.46 0 0 1 .13-.39.49.49 0 1 0-.8-.55 3.31 3.31 0 0 0-.33.38 5.42 5.42 0 0 0-.68 1.12 5.32 5.32 0 0 0-.53 2.93 4.34 4.34 0 0 0 .07.52h-.08a9.59 9.59 0 0 1-1.64.53 11.21 11.21 0 0 1-1.15.22 10.31 10.31 0 0 1-1.29.17 12 12 0 0 1-1.41.1c-.48 0-1.07.05-1.48 0l-1.46-.06"
    ).toNodes()

    val lowerLip = PathParser().parsePathString(
        "M273.94 249c-.48 0-.94-.11-1.39-.15s-.88-.17-1.29-.23-.78-.2-1.13-.29-.65-.22-.93-.31a5 5 0 0 1-.67-.28 2.56 2.56 0 0 0 0-.27 5.08 5.08 0 0 0 0-1.1 6 6 0 0 0-1.12-3 2.65 2.65 0 0 0-.32-.39.5.5 0 0 0-.67-.15.49.49 0 0 0-.15.68 3.33 3.33 0 0 1 .12.39 9.13 9.13 0 0 1 .26 1.06 5.81 5.81 0 0 1-.14 3 6.81 6.81 0 0 1-.31.74l-.43.67c-.18.2-.34.41-.49.61l-.52.51a9 9 0 0 1-.83.74c-.21.18-.33.3-.33.3a.49.49 0 0 0 .5.81s.16-.05.44-.17a6.14 6.14 0 0 0 1.15-.56c.22-.15.48-.3.72-.49s.49-.43.73-.68.45-.57.67-.87.24-.49.35-.74a2.77 2.77 0 0 0 .42.27 7 7 0 0 0 1 .53 7.33 7.33 0 0 0 1.23.48 8.56 8.56 0 0 0 1.41.38c.5.08 1 .2 1.54.24l1.6.09c.61 0 1.05 0 1.58-.07a11.79 11.79 0 0 0 1.53-.18 9.58 9.58 0 0 0 1.44-.31 8.32 8.32 0 0 0 1.25-.42 6.92 6.92 0 0 0 1-.47 5.28 5.28 0 0 0 .6-.36c.09.19.18.37.26.55s.42.62.64.89.48.49.71.71.49.35.71.51a7.4 7.4 0 0 0 1.13.59l.44.18a.47.47 0 0 0 .51-.11.48.48 0 0 0 .01-.6z"
    ).toNodes()
